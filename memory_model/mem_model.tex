...
be printed by both Print 2 and Print 3. Since neither Print 2 nor Print 3 is modifying
...
contains a data race due to the incorrect use of ``flush with a list'' after the
...
the flush operation. The flush operations are strong flushes 
...
variables \ucode{a} and \ucode{b} are atomic write and atomic read operations. 
Otherwise, both examples would contain data races and automatically result 
