...
is an array section, is passed as an actual argument to a procedure that has an assumed-size
array as its dummy argument. The procedure call passing an array section argument
...
procedure returns. This copying would cause races in the \kcode{parallel} region.
