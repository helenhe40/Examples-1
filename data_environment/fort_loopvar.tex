...
\kcode{parallel} construct (see the \docref{Data-Sharing Attribute Rules} section of
the OpenMP Specification document). In the following example of a sequential
