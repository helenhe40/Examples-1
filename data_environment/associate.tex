...
clause. The \docref{Data Sharing Attribute Rules} section of the OpenMP
Specification states that an associate name preserves the association
...
Attribute Rules} section in the OpenMP Specification). Inside the \kcode{parallel}
...
and likewise for the associate name \ucode{a_aray} in the TARGET 2 block.
