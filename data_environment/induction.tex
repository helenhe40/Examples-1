...
For this case, the induction operation is specified
...
An alternative approach is to use an \emph{inscan} reduction
...
\index{directives!declare_induction@\kcode{declare_induction}}
\index{declare_induction directive@\kcode{declare_induction} directive}
\index{inductions!declare_induction directive@\kcode{declare_induction} directive}
...
\kcode{declare_induction} directive and the \kcode{induction} clause.
...
is defined in the \kcode{declare_induction} directive with an
