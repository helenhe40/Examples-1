...
portability. The directives extend the C, C++ and Fortran base languages with \emph{single
program multiple data} (SPMD) constructs, \emph{tasking} constructs, \emph{device} constructs,
\emph{worksharing} constructs, and \emph{synchronization} constructs, and they provide support for
...
This OpenMP Examples \VER{} document and its codes are tagged as  \kcode{\small{}omp_\SVER}.
%Uncomment only when version of Spec and Examples is identical
