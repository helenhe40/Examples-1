...
\kcode{target_data} construct is used to first map the structure, and
...
mapped by an enclosing \kcode{target_data} construct, and then the
...
with the use of the \kcode{declare_target} directive.  Inside the
...
results from the \kcode{declare_target} directive. The \kcode{always}
