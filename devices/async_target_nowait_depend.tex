...
dependences are produced by arrays \ucode{v1} and \ucode{v2}  with the \kcode{out} dependence type in the first two tasks, and the \kcode{in} dependence type in the \emph{target task}.   
