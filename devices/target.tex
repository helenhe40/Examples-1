...
The following example shows how the \kcode{target} construct offloads a code
...
In the OpenMP Specification 5.0, a \kcode{target} region is allowed to
...
immediate parent (\emph{1st ancestor})-- the host.
...
execute on the \emph{host} only. This ensures that no
