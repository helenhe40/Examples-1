...
the \kcode{directive} extension for the C23 and C++11 standard \emph{attributes}.
...
directive ordering does not matter for \kcode{declare_simd} directives. 
...
as prescribed by the two different \kcode{declare_simd} directives
...
used for the \kcode{declare_simd} directives. 
...
in combination with the attribute form of the \kcode{declare_simd} 
