...
to create a \emph{depend object} that expresses a dependence to be 
...
that is specified in the \kcode{depend} clause of a \kcode{depobj} construct,
...
\emph{initialize}, \emph{update} and \emph{uninitialize}
