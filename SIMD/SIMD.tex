%\pagebreak
\section{\kcode{simd} and \kcode{declare_simd} Directives}
\label{sec:SIMD}
...
the loop. In the examples below the \kcode{declare_simd} directive is 
...
The \kcode{declare_simd} directives also illustrate the use of 
...
associated loop. In the \kcode{declare_simd} directive for the \ucode{add3} 
...
The following examples illustrate the use of the \kcode{declare_simd} 
