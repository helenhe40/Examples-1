...
execution at a scheduling point and return later.  The thread is \emph{tied}
...
the task.  An \kcode{if} clause with an expression that evaluates to \vcode{false}
...
can be found in the \docref{Tasking Constructs} chapter of the OpenMP Specification.
...
\input{tasking/free_agent}
\input{tasking/taskgraph}
