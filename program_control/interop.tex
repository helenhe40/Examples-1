...
In the example below, asynchronous cuda memory copies and a \ucode{cublasDaxpy} procedure are executed 
...
Within the block for executing the \ucode{cublasDaxpy} procedure, a stream is acquired 
