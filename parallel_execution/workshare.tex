...
In the following example, the computation of \ucode{SUM(AA)} is workshared. The
scalar assignment statement that updates \ucode{R} is considered a unit of work
that is executed once by one thread.
