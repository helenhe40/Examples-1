...
routine to be called within a task's structured block, and for the routine's
...
In the following example, the program creates a detachable task
...
before Task2 and Task3 are generated (while the asynchronous IO occurs in the ``background'' and eventually
