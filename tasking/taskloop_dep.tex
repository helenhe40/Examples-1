...
the \kcode{if} condition evaluates to \vcode{true}.
For instance, the first task generated from TL2 will update elements
\ucode{A[1:4]} with the \kcode{depend(inout: \ucode{A[4]})}
and \kcode{depend(in: \ucode{A[0]})} clauses. This ensures element \ucode{A[4]}
