...
In OpenMP 6.0, white spaces in some directive names are replaced with
underscores, but the old form is still supported.  For example, 
both \kcode{declare reduction} and \kcode{declare_reduction}
are valid directive names.
...
\input{directives/compound_directive_names}
